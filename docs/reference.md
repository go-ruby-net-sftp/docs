...
The public API lives at the module root (`github.com/go-ruby-net-sftp/net-sftp`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `net-sftp`, while the surface follows
...
```go
import "github.com/go-ruby-net-sftp/net-sftp"
```
...
- **[pkg.go.dev/github.com/go-ruby-net-sftp/net-sftp](https://pkg.go.dev/github.com/go-ruby-net-sftp/net-sftp)**

The module's [README](https://github.com/go-ruby-net-sftp/net-sftp#readme) carries worked
