...
`go-ruby-net-sftp/net-sftp` reimplements Ruby's `net-sftp` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-net-sftp/net-sftp` directly, with no Ruby runtime;
