# go-ruby-net-sftp documentation

**Pure-Go, MRI-4.0.5-faithful Ruby net-sftp (no cgo)**

`go-ruby-net-sftp/net-sftp` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `net-sftp`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-net-sftp/net-sftp`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `net-sftp`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`net-sftp`](https://github.com/go-ruby-net-sftp/net-sftp) | the library — Ruby's `net-sftp` in pure Go |
| [`docs`](https://github.com/go-ruby-net-sftp/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-net-sftp.github.io`](https://github.com/go-ruby-net-sftp/go-ruby-net-sftp.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-net-sftp/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-net-sftp/net-sftp](https://github.com/go-ruby-net-sftp/net-sftp).
